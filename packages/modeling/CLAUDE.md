...
# Benchmarks
npm run bench
node --expose-gc bench/splitPolygon.bench.js
...
- `operations/booleans/` - CSG operations: union, intersect, subtract, scission, minkowski
- `operations/minkowski/` - minkowskiSum (convexity test is `geom3.isConvex`)
...
// poly3 - 3D polygon; plane and boundingSphere are caches, null until computed
{ vertices: [[x,y,z], ...], plane: null, boundingSphere: null }
