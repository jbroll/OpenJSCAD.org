...
},{"../geometries/geom2":25,"../geometries/geom3":41,"../geometries/path2":62,"../geometries/poly3":79,"../utils/flatten":401}],3:[function(require,module,exports){
...
const create=e=>((void 0===e||e.length<3)&&(e=[]),{vertices:e,plane:null,boundingSphere:null});module.exports=create;
...
const create=require("./create"),fromPointsAndPlane=(e,n)=>({vertices:e,plane:n,boundingSphere:null});module.exports=fromPointsAndPlane;
...
const plane=require("../../maths/plane"),create=require("./create"),invert=e=>{const r=e.vertices,n=r.length,t=new Array(n);for(let e=0;e<n;e++)t[e]=r[n-1-e];const a=create(t);return e.plane&&(a.plane=plane.flip(plane.create(),e.plane)),a};module.exports=invert;
...
const vec4=require("../../maths/vec4"),measureBoundingSphere=e=>{if(e.boundingSphere)return e.boundingSphere;const r=e.vertices,n=vec4.create();if(0===r.length)return n[0]=0,n[1]=0,n[2]=0,n[3]=0,n;let t=r[0],o=t,u=t,s=t,c=t,h=t;for(let e=0;e<r.length;e++){const n=r[e];t[0]>n[0]&&(t=n),o[1]>n[1]&&(o=n),u[2]>n[2]&&(u=n),s[0]<n[0]&&(s=n),c[1]<n[1]&&(c=n),h[2]<n[2]&&(h=n)}n[0]=.5*(t[0]+s[0]),n[1]=.5*(o[1]+c[1]),n[2]=.5*(u[2]+h[2]);const i=n[0]-s[0],g=n[1]-c[1],d=n[2]-h[2];return n[3]=Math.sqrt(i*i+g*g+d*d),e.boundingSphere=n,n};module.exports=measureBoundingSphere;
...
},{"./colors":8,"./curves":19,"./geometries":50,"./maths":95,"./measurements":252,"./operations/booleans":266,"./operations/expansions":295,"./operations/extrusions":318,"./operations/hulls":341,"./operations/minkowski":351,"./operations/modifiers":355,"./operations/transforms":365,"./primitives":381,"./text":395,"./utils":403}],93:[function(require,module,exports){
...
},{"../utils/flatten":401,"./measureArea":257}],254:[function(require,module,exports){
...
},{"../maths/vec3/max":225,"../maths/vec3/min":226,"../utils/flatten":401,"./measureBoundingBox":258}],255:[function(require,module,exports){
...
},{"../geometries":50,"../utils/flatten":401,"./calculateEpsilonFromBounds":251,"./measureAggregateBoundingBox":254}],256:[function(require,module,exports){
...
},{"../utils/flatten":401,"./measureVolume":264}],257:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../geometries/geom3":41,"../geometries/path2":62,"../geometries/poly3":79,"../utils/flatten":401}],258:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../geometries/geom3":41,"../geometries/path2":62,"../geometries/poly3":79,"../maths/vec2":191,"../maths/vec3":222,"../utils/flatten":401}],259:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../geometries/geom3":41,"../geometries/path2":62,"../geometries/poly3":79,"../maths/vec2":191,"../maths/vec3":222,"../utils/flatten":401}],260:[function(require,module,exports){
...
},{"../utils/flatten":401,"./measureBoundingBox":258}],261:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../geometries/geom3":41,"../maths/vec3":222,"../utils/flatten":401}],262:[function(require,module,exports){
...
},{"../utils/flatten":401,"./measureBoundingBox":258}],263:[function(require,module,exports){
...
},{"../geometries":50,"../utils/flatten":401,"./calculateEpsilonFromBounds":251,"./measureBoundingBox":258}],264:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../geometries/geom3":41,"../geometries/path2":62,"../geometries/poly3":79,"../utils/flatten":401}],265:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../utils/areAllShapesTheSameType":399,"../../utils/flatten":401,"./intersectGeom2":268,"./intersectGeom3":269}],268:[function(require,module,exports){
...
},{"../../geometries/geom3":41,"../../measurements/measureEpsilon":263,"../../utils/flatten":401,"./fromFakePolygons":265,"./intersectGeom3":269,"./to3DWalls":278}],269:[function(require,module,exports){
...
},{"../../utils/flatten":401,"../modifiers/retessellate":359,"./intersectGeom3Sub":270}],270:[function(require,module,exports){
...
},{"../../geometries/geom3":41,"../../utils/flatten":401,"./scissionGeom3":273}],273:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../utils/areAllShapesTheSameType":399,"../../utils/flatten":401,"./subtractGeom2":275,"./subtractGeom3":276}],275:[function(require,module,exports){
...
},{"../../geometries/geom3":41,"../../measurements/measureEpsilon":263,"../../utils/flatten":401,"./fromFakePolygons":265,"./subtractGeom3":276,"./to3DWalls":278}],276:[function(require,module,exports){
...
},{"../../utils/flatten":401,"../modifiers/retessellate":359,"./subtractGeom3Sub":277}],277:[function(require,module,exports){
...
const{EPS:EPS}=require("../../../maths/constants"),plane=require("../../../maths/plane"),vec3=require("../../../maths/vec3"),poly3=require("../../../geometries/poly3"),splitLineSegmentByPlane=require("./splitLineSegmentByPlane"),EPS_SQUARED=EPS*EPS,pool={result:{type:null,front:null,back:null},vertexIsBack:new Array(64),frontvertices:new Array(32),backvertices:new Array(32)},removeConsecutiveDuplicates=(e,t)=>{const n=void 0!==t?t:e.length;if(n<3)return e.slice(0,n);const l=[];let o=e[n-1];for(let t=0;t<n;t++){const n=e[t];vec3.squaredDistance(n,o)>=EPS_SQUARED&&l.push(n),o=n}return l},splitPolygonByPlane=(e,t)=>{const n=pool.result;n.type=null,n.front=null,n.back=null;const l=t.vertices,o=l.length,r=poly3.plane(t);if(plane.equals(r,e))n.type=0;else{let t=!1,s=!1,c=pool.vertexIsBack;c.length<o&&(c=pool.vertexIsBack=new Array(2*o));const i=-EPS;for(let n=0;n<o;n++){const o=vec3.dot(e,l[n])-e[3],r=o<i;c[n]=r,o>EPS&&(t=!0),o<i&&(s=!0)}if(t||s)if(s)if(t){n.type=4;const t=2*o;let s=pool.frontvertices,i=pool.backvertices;s.length<t&&(s=pool.frontvertices=new Array(t)),i.length<t&&(i=pool.backvertices=new Array(t));let a=0,p=0,u=c[0];for(let t=0;t<o;t++){const n=l[t];let r=t+1;r>=o&&(r=0);const y=c[r];if(u===y)u?i[p++]=n:s[a++]=n;else{const t=l[r],o=splitLineSegmentByPlane(e,n,t);u?(i[p++]=n,i[p++]=o,s[a++]=o):(s[a++]=n,s[a++]=o,i[p++]=o)}u=y}if(a>=3){const e=removeConsecutiveDuplicates(s,a);e.length>=3&&(n.front=poly3.fromPointsAndPlane(e,r))}if(p>=3){const e=removeConsecutiveDuplicates(i,p);e.length>=3&&(n.back=poly3.fromPointsAndPlane(e,r))}}else n.type=3;else n.type=2;else{const t=vec3.dot(e,r);n.type=t>=0?0:1}}return n};module.exports=splitPolygonByPlane;
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../utils/areAllShapesTheSameType":399,"../../utils/flatten":401,"./unionGeom2":286,"./unionGeom3":287}],286:[function(require,module,exports){
...
},{"../../geometries/geom3":41,"../../measurements/measureEpsilon":263,"../../utils/flatten":401,"./fromFakePolygons":265,"./to3DWalls":278,"./unionGeom3":287}],287:[function(require,module,exports){
...
},{"../../utils/flatten":401,"../modifiers/retessellate":359,"./unionGeom3Sub":288}],288:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../utils/flatten":401,"./expandGeom2":290,"./expandGeom3":291,"./expandPath2":292}],290:[function(require,module,exports){
...
},{"../../geometries/geom3":41,"../../geometries/poly3":79,"../../maths/constants":94,"../../maths/mat4":143,"../../maths/vec3":222,"../../primitives/sphere":389,"../../utils/fnNumberSort":402,"../booleans/unionGeom3Sub":288,"../modifiers/retessellate":359,"./extrudePolygon":294}],294:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/path2":62,"../../utils/flatten":401,"./offsetGeom2":298,"./offsetPath2":299}],297:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/path2":62,"../../utils/flatten":401,"./extrudeLinearGeom2":311,"./extrudeLinearPath2":312}],311:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/path2":62,"../../utils/flatten":401,"./extrudeRectangularGeom2":314,"./extrudeRectangularPath2":315}],314:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../maths/constants":94,"../../maths/mat4":143,"../transforms/mirror":366,"./extrudeFromSlices":308,"./slice":326}],317:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/poly3":79,"../../maths/mat4":143,"../../maths/plane":163,"../../maths/utils/aboutEqualNormals":167,"../../measurements/measureEpsilon":263,"../../utils/flatten":401,"../booleans/unionGeom2":286}],320:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../utils/areAllShapesTheSameType":399,"../../utils/flatten":401,"./hullGeom2":336,"./hullGeom3":337,"./hullPath2":338}],335:[function(require,module,exports){
...
},{"../../utils/flatten":401,"../booleans/union":285,"./hull":334}],336:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../utils/flatten":401,"./hullPoints2":339,"./toUniquePoints":350}],337:[function(require,module,exports){
...
},{"../../geometries/geom3":41,"../../utils/flatten":401,"./hullPoints3":340,"./toUniquePoints":350}],338:[function(require,module,exports){
...
},{"../../geometries/path2":62,"../../utils/flatten":401,"./hullPoints2":339,"./toUniquePoints":350}],339:[function(require,module,exports){
...
module.exports={isConvex:require("./isConvex"),minkowskiSum:require("./minkowskiSum")};

},{"./isConvex":352,"./minkowskiSum":353}],352:[function(require,module,exports){
const{EPS:EPS}=require("../../maths/constants"),vec3=require("../../maths/vec3"),geom3=require("../../geometries/geom3"),poly3=require("../../geometries/poly3"),isConvex=e=>{if(!geom3.isA(e))throw new Error("isConvex requires a geom3 geometry");const o=geom3.toPolygons(e);if(0===o.length)return!0;const t=[],r=new Set;for(let e=0;e<o.length;e++){const n=o[e].vertices;for(let e=0;e<n.length;e++){const o=n[e],s=`${o[0]},${o[1]},${o[2]}`;r.has(s)||(r.add(s),t.push(o))}}for(let e=0;e<o.length;e++){const r=poly3.plane(o[e]);for(let e=0;e<t.length;e++){const o=t[e];if(vec3.dot(r,o)-r[3]>EPS)return!1}}return!0};module.exports=isConvex;

},{"../../geometries/geom3":41,"../../geometries/poly3":79,"../../maths/constants":94,"../../maths/vec3":222}],353:[function(require,module,exports){
const flatten=require("../../utils/flatten"),geom3=require("../../geometries/geom3"),poly3=require("../../geometries/poly3"),hullPoints3=require("../hulls/hullPoints3"),union=require("../booleans/union"),isConvex=require("./isConvex"),minkowskiSum=(...e)=>{if((e=flatten(e)).length<2)throw new Error("minkowskiSum requires at least two geometries");if(e.length>2)throw new Error("minkowskiSum currently supports exactly two geometries");const[o,t]=e;if(!geom3.isA(o)||!geom3.isA(t))throw new Error("minkowskiSum requires geom3 geometries");const n=isConvex(o),r=isConvex(t);if(n&&r)return minkowskiSumConvex(o,t);if(!n&&r)return minkowskiSumNonConvexConvex(o,t);if(n&&!r)return minkowskiSumNonConvexConvex(t,o);throw new Error("minkowskiSum of two non-convex geometries is not yet supported")},minkowskiSumNonConvexConvex=(e,o)=>{const t=decomposeIntoTetrahedra(e);if(0===t.length)return geom3.create();const n=t.map(e=>minkowskiSumConvex(e,o));return 1===n.length?n[0]:union(n)},decomposeIntoTetrahedra=e=>{const o=geom3.toPolygons(e);if(0===o.length)return[];const t=computeCentroid(e),n=[];for(let e=0;e<o.length;e++){const r=o[e].vertices;for(let e=1;e<r.length-1;e++){const o=r[0],i=r[e],s=r[e+1],u=createTetrahedronPolygons(t,o,i,s);n.push(geom3.create(u))}}return n},createTetrahedronPolygons=(e,o,t,n)=>[poly3.create([e,t,o]),poly3.create([e,o,n]),poly3.create([o,t,n]),poly3.create([t,e,n])],computeCentroid=e=>{const o=extractUniqueVertices(e);if(0===o.length)return[0,0,0];let t=0,n=0,r=0;for(let e=0;e<o.length;e++)t+=o[e][0],n+=o[e][1],r+=o[e][2];const i=o.length;return[t/i,n/i,r/i]},minkowskiSumConvex=(e,o)=>{const t=extractUniqueVertices(e),n=extractUniqueVertices(o);if(0===t.length||0===n.length)return geom3.create();const r=[];for(let e=0;e<t.length;e++){const o=t[e];for(let e=0;e<n.length;e++){const t=n[e];r.push([o[0]+t[0],o[1]+t[1],o[2]+t[2]])}}const i=hullPoints3(r);return geom3.create(i)},extractUniqueVertices=e=>{const o=new Set,t=[],n=geom3.toPolygons(e);for(let e=0;e<n.length;e++){const r=n[e].vertices;for(let e=0;e<r.length;e++){const n=r[e],i=`${n[0]},${n[1]},${n[2]}`;o.has(i)||(o.add(i),t.push(n))}}return t};module.exports=minkowskiSum;

},{"../../geometries/geom3":41,"../../geometries/poly3":79,"../../utils/flatten":401,"../booleans/union":285,"../hulls/hullPoints3":340,"./isConvex":352}],354:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../measurements/measureEpsilon":263,"../../utils/flatten":401,"./insertTjunctions":356,"./mergePolygons":357,"./snapPolygons":361,"./triangulatePolygons":362}],355:[function(require,module,exports){
...
},{"../../geometries/poly3":79,"../../maths/constants":94,"../../maths/vec3":222}],357:[function(require,module,exports){
...
},{"../../geometries/poly3":79,"../../maths/utils/aboutEqualNormals":167,"../../maths/vec3":222}],358:[function(require,module,exports){
const{EPS:EPS}=require("../../maths/constants"),line2=require("../../maths/line2"),vec2=require("../../maths/vec2"),OrthoNormalBasis=require("../../maths/OrthoNormalBasis"),interpolateBetween2DPointsForY=require("../../maths/utils/interpolateBetween2DPointsForY"),{insertSorted:insertSorted,fnNumberSort:fnNumberSort}=require("../../utils"),poly3=require("../../geometries/poly3"),reTesselateCoplanarPolygons=t=>{if(t.length<2)return t;const e=[],o=t.length,n=poly3.plane(t[0]),l=new OrthoNormalBasis(n),i=[],r=[],s=new Map,p=new Map,f=new Map,h=10/EPS;for(let e=0;e<o;e++){const o=t[e];let n=[],g=o.vertices.length,a=-1;if(g>0){let t,i;for(let r=0;r<g;r++){const s=l.to2D(o.vertices[r]),g=Math.floor(s[1]*h);let c;f.has(g)?c=f.get(g):f.has(g+1)?c=f.get(g+1):f.has(g-1)?c=f.get(g-1):(c=s[1],f.set(g,s[1])),s[1]=c,n.push(s);const u=s[1];(0===r||u<t)&&(t=u,a=r),(0===r||u>i)&&(i=u);let m=p.get(u);m||(m={},p.set(u,m)),m[e]=!0}if(t>=i)n=[],g=0,a=-1;else{let o=s.get(t);o||(o=[],s.set(t,o)),o.push(e)}}n.reverse(),a=g-a-1,i.push(n),r.push(a)}const g=[];p.forEach((t,e)=>g.push(e)),g.sort(fnNumberSort);let a=[],c=[];for(let t=0;t<g.length;t++){const o=[],f=g[t],h=p.get(f);let u,m=0;for(let t=0;t<a.length;++t){const e=a[t],o=e.polygonindex;if(h[o]){const t=i[o],n=t.length;let l=e.leftvertexindex,r=e.rightvertexindex;for(;;){let e=l+1;if(e>=n&&(e=0),t[e][1]!==f)break;l=e}let s=r-1;if(s<0&&(s=n-1),t[s][1]===f&&(r=s),l!==e.leftvertexindex&&l===r)e._remove=!0,m++;else{e.leftvertexindex=l,e.rightvertexindex=r,e.topleft=t[l],e.topright=t[r];let o=l+1;o>=n&&(o=0),e.bottomleft=t[o];let i=r-1;i<0&&(i=n-1),e.bottomright=t[i]}}}if(m>0&&(a=a.filter(t=>!t._remove)),t>=g.length-1)a=[],u=null;else{const e=.5*(f+(u=Number(g[t+1]))),o=s.get(f);for(const t in o){const n=o[t],l=i[n],s=l.length,p=r[n];let h=p;for(;;){let t=h+1;if(t>=s&&(t=0),l[t][1]!==f)break;if(t===p)break;h=t}let g=p;for(;;){let t=g-1;if(t<0&&(t=s-1),l[t][1]!==f)break;if(t===h)break;g=t}let c=h+1;c>=s&&(c=0);let u=g-1;u<0&&(u=s-1);const m={polygonindex:n,leftvertexindex:h,rightvertexindex:g,topleft:l[h],topright:l[g],bottomleft:l[c],bottomright:l[u]};insertSorted(a,m,(t,o)=>{const n=interpolateBetween2DPointsForY(t.topleft,t.bottomleft,e),l=interpolateBetween2DPointsForY(o.topleft,o.bottomleft,e);return n>l?1:n<l?-1:0})}}for(const t in a){const e=a[t],n=[interpolateBetween2DPointsForY(e.topleft,e.bottomleft,f),f],l=[interpolateBetween2DPointsForY(e.topright,e.bottomright,f),f],i=[interpolateBetween2DPointsForY(e.topleft,e.bottomleft,u),u],r=[interpolateBetween2DPointsForY(e.topright,e.bottomright,u),u],s={topleft:n,topright:l,bottomleft:i,bottomright:r,leftline:line2.fromPoints(line2.create(),n,i),rightline:line2.fromPoints(line2.create(),r,l)};if(o.length>0){const t=o[o.length-1],e=vec2.distance(s.topleft,t.topright),n=vec2.distance(s.bottomleft,t.bottomright);e<EPS&&n<EPS&&(s.topleft=t.topleft,s.leftline=t.leftline,s.bottomleft=t.bottomleft,o.splice(o.length-1,1))}o.push(s)}if(t>0){const t=new Set,i=new Set;for(let e=0;e<o.length;e++){const n=o[e];for(let e=0;e<c.length;e++)if(!i.has(e)){const o=c[e];if(vec2.distance(o.bottomleft,n.topleft)<EPS&&vec2.distance(o.bottomright,n.topright)<EPS){i.add(e);const l=line2.direction(n.leftline),r=line2.direction(o.leftline),s=l[0]-r[0],p=line2.direction(n.rightline),f=line2.direction(o.rightline),h=p[0]-f[0],g=Math.abs(s)<EPS,a=Math.abs(h)<EPS,c=a||h>=0;(g||s>=0)&&c&&(n.outpolygon=o.outpolygon,n.leftlinecontinues=g,n.rightlinecontinues=a,t.add(e));break}}}for(let o=0;o<c.length;o++)if(!t.has(o)){const t=c[o];t.outpolygon.rightpoints.push(t.bottomright),vec2.distance(t.bottomright,t.bottomleft)>EPS&&t.outpolygon.leftpoints.push(t.bottomleft),t.outpolygon.leftpoints.reverse();const i=t.outpolygon.rightpoints.concat(t.outpolygon.leftpoints).map(t=>l.to3D(t)),r=poly3.fromPointsAndPlane(i,n);r.vertices.length&&e.push(r)}}for(let t=0;t<o.length;t++){const e=o[t];e.outpolygon?(e.leftlinecontinues||e.outpolygon.leftpoints.push(e.topleft),e.rightlinecontinues||e.outpolygon.rightpoints.push(e.topright)):(e.outpolygon={leftpoints:[],rightpoints:[]},e.outpolygon.leftpoints.push(e.topleft),vec2.distance(e.topleft,e.topright)>EPS&&e.outpolygon.rightpoints.push(e.topright))}c=o}return e};module.exports=reTesselateCoplanarPolygons;

},{"../../geometries/poly3":79,"../../maths/OrthoNormalBasis":93,"../../maths/constants":94,"../../maths/line2":105,"../../maths/utils/interpolateBetween2DPointsForY":170,"../../maths/vec2":191,"../../utils":403}],359:[function(require,module,exports){
...
},{"../../geometries/geom3":41,"../../geometries/poly3":79,"../../maths/constants":94,"./reTesselateCoplanarPolygons":358}],360:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../maths/vec2":191,"../../measurements/measureEpsilon":263,"../../utils/flatten":401,"./snapPolygons":361}],361:[function(require,module,exports){
...
},{"../../geometries/poly3":79,"../../maths/vec3":222}],362:[function(require,module,exports){
...
},{"../../geometries/poly3":79,"../../maths/vec3":222}],363:[function(require,module,exports){
...
},{"../../measurements/measureAggregateBoundingBox":254,"../../utils/flatten":401,"../../utils/padArrayToLength":405,"./translate":370}],364:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../measurements/measureBoundingBox":258,"../../utils/flatten":401,"./translate":370}],365:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../maths/mat4":143,"../../maths/plane":163,"../../utils/flatten":401}],367:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../maths/mat4":143,"../../utils/flatten":401}],368:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../maths/mat4":143,"../../utils/flatten":401}],369:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../utils/flatten":401}],370:[function(require,module,exports){
...
},{"../../geometries/geom2":25,"../../geometries/geom3":41,"../../geometries/path2":62,"../../maths/mat4":143,"../../utils/flatten":401}],371:[function(require,module,exports){
...
},{"../geometries/path2":62,"../maths/constants":94,"../maths/vec2":191,"./commonChecks":373}],372:[function(require,module,exports){
...
},{"../maths/constants":94,"./commonChecks":373,"./ellipse":378}],373:[function(require,module,exports){
...
},{"../geometries/geom3":41,"../geometries/poly3":79,"./commonChecks":373}],376:[function(require,module,exports){
...
},{"../geometries/geom3":41,"../geometries/poly3":79,"../maths/constants":94,"../maths/utils/trigonometry":173,"../maths/vec3":222,"./commonChecks":373}],378:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../maths/constants":94,"../maths/utils/trigonometry":173,"../maths/vec2":191,"./commonChecks":373}],379:[function(require,module,exports){
...
},{"../geometries/geom3":41,"../geometries/poly3":79,"../maths/constants":94,"../maths/utils/trigonometry":173,"../maths/vec3":222,"./commonChecks":373}],380:[function(require,module,exports){
...
},{"../geometries/geom3":41,"../maths/mat4":143,"../maths/vec3":222,"./commonChecks":373,"./polyhedron":384}],381:[function(require,module,exports){
...
},{"../geometries/path2":62}],383:[function(require,module,exports){
...
},{"../geometries/geom3":41,"../geometries/poly3":79,"./commonChecks":373}],385:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../maths/vec2":191,"./commonChecks":373}],386:[function(require,module,exports){
...
},{"../geometries/geom3":41,"../geometries/poly3":79,"../maths/constants":94,"../maths/utils/trigonometry":173,"../maths/vec2":191,"../maths/vec3":222,"./commonChecks":373,"./cuboid":375}],387:[function(require,module,exports){
...
},{"../geometries/geom3":41,"../geometries/poly3":79,"../maths/constants":94,"../maths/utils/trigonometry":173,"../maths/vec3":222,"./commonChecks":373,"./cylinder":376}],388:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../maths/constants":94,"../maths/vec2":191,"./commonChecks":373,"./rectangle":385}],389:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../maths/constants":94,"../maths/vec2":191,"./commonChecks":373}],392:[function(require,module,exports){
...
},{"../maths/constants":94,"../operations/extrusions/extrudeRotate":316,"../operations/transforms/rotate":367,"../operations/transforms/translate":370,"./circle":372,"./commonChecks":373}],393:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../maths/constants":94,"../maths/vec2":191,"./commonChecks":373}],394:[function(require,module,exports){
...
},{"../geometries/geom2":25,"../geometries/geom3":41,"../geometries/path2":62}],400:[function(require,module,exports){
